#!/usr/bin/env python3
"""
predictor.py — MLX MedSAM2 (FINAL WORKING VERSION)

- Exact SAM2 token order restored: [obj_score_token, iou_token, mask_tokens..., sparse]
- This fixes the negative IoU while masks stay perfect
- PIL removed: all resize ops use nn.Upsample with correct MLX mode names
